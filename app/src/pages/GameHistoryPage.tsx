...
export default function GameHistoryPage () {
    ...
    return <>
        ...
        {games ? games.map((game) => { return <div className="flex w-full mb-3">
            <div className="card bg-base-300 rounded-box grid h-32 flex-grow place-items-center">
                ...
                {game.creator === game.winner ? <div className="badge badge-primary">Gagnant</div> :
                    <div className="badge badge-secondary">Perdant</div>}
            ...
            <div className="card bg-base-300 rounded-box grid h-32 flex-grow place-items-center">
                ...
                {game.player === game.winner ? <div className="badge badge-primary">Gagnant</div> :
                    <div className="badge badge-secondary">Perdant</div>}
            </div>
        </div>
        }) : ""}
